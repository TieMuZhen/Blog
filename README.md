...
- [position的四个属性值：relative(不脱流)、fixed、absolute、sticky](https://www.ruanyifeng.com/blog/2019/11/css-position.html)
- 行内元素、块级元素
...
- 元素居中
  ...
  - [单行文字居中，多行文字居左](https://juejin.cn/post/6844904030469095432)
  - [元素居中显示](../../issues/36)
- 性能优化
...
- [DNS劫持如何避免和解决?](https://segmentfault.com/a/1190000039759438)
...
- 缓存
  - [浏览器的缓存机制。强缓存(200(from disk cache))：Expires、Cache-Control，协商缓存(304)：Last-Modified/If-Modified-since、Etag/If-None-Match](https://juejin.cn/post/6844903593275817998)
...
- [线程安全之集合类（List、Map、Set），同步容器（Vector、Collections.synchronized）、并发容器（JUC）](https://zhuanlan.zhihu.com/p/94839190)
- 锁 
...
- [线程通信方式（volatile、synchronized、JUC工具类 CountDownLatch）](https://blog.csdn.net/qq_42411214/article/details/107767326) 
...
- [Buffer和Stream区别](https://zhuanlan.zhihu.com/p/31355139)
...
- [白屏优化](https://febook.hzfe.org/awesome-interview/book3/topic-white-screen-optimization)
...
- [进程调度策略](https://www.jianshu.com/p/6754a5e72067)
